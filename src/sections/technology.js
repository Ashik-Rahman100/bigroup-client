        ...
        >
          {skillsData.map((skill, id) => (
            <div
              ...
              key={id}
            >
              <div className="h-full w-full rounded-lg   border-2 border-violet-500   shadow-none shadow-gray-50 group-hover:border-violet-500 transition-all duration-500">
